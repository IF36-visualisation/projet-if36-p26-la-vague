...
ggplot(merged_games_log,
  ...
  labs(
    ...
    subtitle = "Identification des jeux atypiques par rapport à la tendance générale",
...
ggplot(speedrun_by_constructeur,
  ...
  labs(
    ...
    subtitle = "Nombre total de runs speedrun selon le constructeur associé au jeu",
    x = "Constructeur",
    y = "Nombre total de runs speedrun",
    fill = "Constructeur"
  ) +
