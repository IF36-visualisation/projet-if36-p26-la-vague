...
videoGameSales <- read_csv("Video_Games_Sales_as_at_22_Dec_2016.csv")
```
...
## 2. Quels sont les genres de jeux vidéo qui génèrent le plus de ventes ? {#q2-genres}
...
## 4. Observe-t-on des différences régionales dans les préférences de plateformes ou de genres ? {#q4-differences}
